...
BIS_WL_factionUnitClasses = [
	...
	[
		...
		"LIB_UK_AT_Soldier_w",		30, //PCML, default 20
		"LIB_US_AT_soldier_w",		60, //MAAWS? , deault 20
		"LIB_UK_Corporal_w",		15, //Squad leader, default 15
		"LIB_US_Second_lieutenant_w",		15, //Squad leader, default 15
		"LIB_UK_Medic_w",			20, //Medic, default 15
		"LIB_US_Medic_w",			20, //Medic, default 15
		"LIB_UK_Engineer_w",			5, //engineer, default 15
		"LIB_US_Engineer_w",			5, //engineer, default 15
		"LIB_UK_Sergeant_w",			5, //officer, default 10
		"LIB_US_Sniper_w",			5, //sniper, default 10
		"LIB_UK_Sniper_w",			5 //sniper, default 10
	]
];
...
BIS_WL_factionVehicleClasses = [
	...
	[
		...
		"LIB_Cromwell_Mk4_w",		60, //Gorgan, default 50
		"LIB_M4A3_75_w",		40, //Mora, default 50
